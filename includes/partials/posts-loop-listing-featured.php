...
<article <?php post_class( 'publisher-ext listing-wrap listing-featured cover' ); ?>>
	<div class="article-wrap">

		<?php
			// Featured Image
			$image_size = ( 'default' != $instance['image_size'] ) ? $instance['image_size'] : publisher_get_the_image_size( 'listing-featured' );
